...
const DEFAULT_REF_DOMAIN = 'welect.de';
...
export const spec = {
   ...
   * @param {bidderRequest} - context of the bidder request
  ...
  buildRequests: function (validBidRequests, bidderRequest) {
    ...
    if (bidderRequest && bidderRequest.refererInfo) {
      refererInfo = {
        domain: bidderRequest.refererInfo.domain || DEFAULT_REF_DOMAIN,
    ...
    return validBidRequests.map((bidRequest) => {
      ...
      const data = {
        ...
        cattax: bidRequest.params.cattax || "",
        cat: bidRequest.params.cat || "",
        ...gdprConsent,
        ...refererInfo,
      };
